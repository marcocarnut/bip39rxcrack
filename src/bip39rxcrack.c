...
static int mode_crack_pass(const char*mnemonic,const PPat*pp,const uint8_t tprog[32],
  ...
  PassCtx P; if(crack_pass_setup(&P,mnemonic,pp,tprog,purpose,changes,gap,accounts,cu,aset)) return 2;
...
static int run_worker_pass(const char*mnemonic,const PPat*pp,const uint8_t tprog[32],int purpose,uint32_t changes,uint32_t gap,uint32_t accounts,
